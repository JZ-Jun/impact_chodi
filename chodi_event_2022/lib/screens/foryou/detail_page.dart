              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    getInfoItem(
                        '', widget.ngoInfo.contactNumber ?? '', Icons.phone),
                    Row(
                      children: [
                        Container(
                          width: 150,
                            ...
                            child: Container(
                                ...
                                child: Column(
                                  children: [
                                    getInfoItem(
                                        'Location:',
                                        widget.ngoInfo.state ?? '',
                                        Icons.place),
                                    getInfoItem(
                                        'Categories:',
                                        widget.ngoInfo.category ?? '',
                                        Icons.equalizer),
                                    getInfoItem(
                                        'Year Founded:',
                                        widget.ngoInfo.founded ?? 0,
                                        Icons.event),
                                    getInfoItem(
                                        'Size:',
                                        widget.ngoInfo.orgSize ?? 0,
                                        Icons.perm_identity)
                                  ],
                                )))
                      ],
